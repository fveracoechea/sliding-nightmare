class SlidingNightmare {
  constructor(carouselId, options = {}){
    ...
    this.itemsPadding = (itemsPadding) ? `padding-right: ${itemsPadding}px;` : false;
    this.iamgePaddingVertical = iamgePaddingVertical;
    this.widthItems = `${(this.inner.offsetWidth / numOfVisibleElements) - itemsPadding}px`;
    this.addStyles();
  ...
  calcInnerWidth(){
    this.inner.style.width = `${this.visibleItmes.length * this.itemsOffsetWidth}px`;
  }
  addStyles(){
    const html = `
    ...
    .sliding-nightmare .nightmare-inner .nightmare-item {
      ...
      position: relative;
      height: 100%;
      ${(this.itemsPadding) ? this.itemsPadding : ''}
      width: ${this.widthItems};
    }
    .sliding-nightmare .nightmare-inner .nightmare-item img {
      box-sizing: border-box;
      width: 100%;
      height: 100%;
      ${this.cover ? 'object-fit: cover;' : ''}
      padding-right: ${this.iamgePaddingVertical};
      padding-left: ${this.iamgePaddingVertical};
    }
